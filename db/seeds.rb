...
joy = Female.create ({
        ...
        image: 'https://miro.medium.com/max/1000/1*lmOZ-NZ1usxBIfirVOV3EQ.png',
...
erica = Female.create({
        ...
        image: 'https://miro.medium.com/max/1000/1*2VzpucAnyCdIqd4D-bwY2g.png',
...
kimberly = Female.create({
          ...
          image: 'https://miro.medium.com/max/1000/1*eKamAf9Vi0zpR9HTgmY4Aw.png',
...
reshma = Female.create({
        ...
        image: 'https://miro.medium.com/max/1000/1*HSIaWiwqOoOUi8YCB_oT6g.png',
...
catherine = Female.create({
    ...
    image: 'https://miro.medium.com/max/1000/1*R_41f0irw12-W0IiL6tJrQ.png',
...
naz = Female.create({
    ...
    image: 'https://miro.medium.com/max/1000/1*d3X02I7sNNIF7cqhSUtInw.png',
...
manon = Female.create({
    ...
    image: 'https://miro.medium.com/max/1000/1*sdGnBxoiG7hVlAI6YW3pyA.png',
...
sammi = Female.create({
    ...
    image: 'https://miro.medium.com/max/1000/1*baVWRbNi5S7os3mufHGeRQ.png',
...
fariha = Female.create({
    ...
    image: 'https://miro.medium.com/max/1152/1*dPCpwWM9eqh-rbsiPR3bRA.png',
...
juliana = Female.create({
    ...
    image: 'https://miro.medium.com/max/1152/1*XjyfpUOI853eVJtgny2u0g.png',
